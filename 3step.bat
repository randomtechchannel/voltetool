...
echo [+] Dang chay script 1 (script1.bat o thu muc goc)...
if exist "%ROOT_DIR%mtkdump.bat" (
    cd /d "%ROOT_DIR%"
    call "mtkdump.bat"
    echo [OK] Da xong script 1.
) else (
    echo [LOI] Khong tim thay file script1.bat
)
...
echo.
echo ===================================================
echo     DA HOAN THANH TAT CA 3 SCRIPT!
echo ===================================================
pause